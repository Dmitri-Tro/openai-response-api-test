import { PricingService, type TokenUsage } from './pricing.service';
...
describe('PricingService', () => {
  ...
  describe('calculateCost', () => {
    ...
    describe('o1 model (with reasoning)', () => {
      it('should calculate cost with reasoning tokens', () => {
        const cost = service.calculateCost('o1', {
          input_tokens: 1_000,
          output_tokens: 500,
    ...
    describe('o3-mini model', () => {
      it('should calculate cost for o3-mini with all token types', () => {
        const cost = service.calculateCost('o3-mini', {
          input_tokens: 10_000,
          input_tokens_details: {
            cached_tokens: 5_000,
          },
    ...
    describe('gpt-5 model', () => {
      it('should calculate cost for gpt-5 with reasoning', () => {
        const cost = service.calculateCost('gpt-5', {
          input_tokens: 5_000,
          output_tokens: 2_000,
          output_tokens_details: {
    ...
    describe('edge cases', () => {
      ...
      it('should return 0 for null usage', () => {
        const cost = service.calculateCost('gpt-4o', null);
        expect(cost).toBe(0);
      });

      it('should return 0 for undefined usage', () => {
        const cost = service.calculateCost('gpt-4o', undefined);
        expect(cost).toBe(0);
      });
  ...
  describe('estimateCost', () => {
    ...
    it('should handle usage with reasoning tokens', () => {
      ...
      const cost = service.estimateCost('o1', usage);
      expect(cost).toBeCloseTo(0.000225, 10);
    });

    it('should return 0 for undefined usage', () => {
      const cost = service.estimateCost('gpt-4o', undefined);
      expect(cost).toBe(0);
    });
    ...
    it('should match calculateCost for same input', () => {
      ...
      const costFromCalculate = service.calculateCost('gpt-4o', usage);
      const costFromEstimate = service.estimateCost('gpt-4o', usage);
